const features = [
  {
    ...
    glow: 'group-hover:shadow-[0_0_20px_rgba(251,191,36,0.12)]',
  ...
  },
  {
    ...
    glow: 'group-hover:shadow-[0_0_20px_rgba(74,222,128,0.12)]',
  ...
  },
  {
    ...
    glow: 'group-hover:shadow-[0_0_20px_rgba(167,139,250,0.12)]',
  ...
  },
  {
    ...
    color: 'text-rose-400',
    glow: 'group-hover:shadow-[0_0_20px_rgba(251,113,133,0.12)]',
      ...
      <div className="mx-auto max-w-6xl pt-16 sm:pt-28">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-zinc-800/50 rounded-2xl overflow-hidden border border-zinc-800">
          {features.map((f) => (
            <div
              key={f.title}
              className={`group relative bg-[#0a0a0a] p-6 transition-all duration-300 ${f.glow} ${f.border} border border-transparent`}
            >
              {/* Hover background */}
